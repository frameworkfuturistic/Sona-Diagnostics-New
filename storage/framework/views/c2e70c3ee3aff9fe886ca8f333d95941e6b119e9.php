            ...
            <table class="table table-hover" id="dataTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td colspan="2"> 
                                <button class="btn btn-success btn-sm" onclick="window.location.href='api/generateReport/<?php echo e($appointment->id); ?>'">Generate Report</button>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\HMS\resources\views/admin/completed_appointment.blade.php ENDPATH**/ ?>