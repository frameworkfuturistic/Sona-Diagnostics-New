...
<?php $component->withAttributes([]); ?>
    <?php if(session()->has('message')): ?>
        <div class="alert alert-danger alert_css">
...
<?php endif; ?>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="flex items-center">
                    <span class="ml-2 text-sm text-gray-600">Haven't an Account</span> &nbsp; 
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/register">Register here</a>
                </label>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\HMS\resources\views/auth/login.blade.php ENDPATH**/ ?>