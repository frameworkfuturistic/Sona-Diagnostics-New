...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <!-- My Appointments -->
            <a href="<?php echo e(url('myappointment')); ?>" class="appointment-btn scrollto"><span class="d-none d-md-inline">My</span>
                Appointment</a> 
            <!-- My Appointments -->
...
<?php endif; ?>
            <?php else: ?>
            <a href="<?php echo e(Route('login')); ?>" class="appointment-btn scrollto"><span class="d-none d-md-inline"><i class="fa fa-user"></i></span>
            Login/ Register</a>
            <!-- User Login buttons -->
            <?php endif; ?>
            <?php endif; ?>
...
<?php /**PATH D:\laragon\www\HMS\resources\views/user/app.blade.php ENDPATH**/ ?>